/*
	accessible dropdown menu by
	Matt Hinchliffe (https://jsfiddle.net/i_like_robots)
...
/*
    ...
    <button type="button" data-behaviour="button" id="foo">Menu</button>
    <div id="menu-01" data-behaviour="menu">
        <ul>
            <li>
